...
var (
	...
	versionedAttributeGeneratedColumns      = []string{}
)
...
func (q versionedAttributeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*VersionedAttribute, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for versioned_attributes")
	}
...
func (q versionedAttributeQuery) All(ctx context.Context, exec boil.ContextExecutor) (VersionedAttributeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to VersionedAttribute slice")
	}
...
func (q versionedAttributeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count versioned_attributes rows")
	}
...
func (q versionedAttributeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if versioned_attributes exists")
	}
...
func VersionedAttributes(mods ...qm.QueryMod) versionedAttributeQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"versioned_attributes\".*"})
	}

	return versionedAttributeQuery{q}
}
...
func FindVersionedAttribute(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*VersionedAttribute, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from versioned_attributes")
	}
...
func (o *VersionedAttribute) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no versioned_attributes provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into versioned_attributes")
	}
...
func (o *VersionedAttribute) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update versioned_attributes, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update versioned_attributes row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for versioned_attributes")
	}
...
func (q versionedAttributeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for versioned_attributes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for versioned_attributes")
	}
...
func (o VersionedAttributeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in versionedAttribute slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all versionedAttribute")
	}
	return rowsAff, nil
}
...
func (o *VersionedAttribute) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no VersionedAttribute provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from versioned_attributes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for versioned_attributes")
	}
...
func (q versionedAttributeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no versionedAttributeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from versioned_attributes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for versioned_attributes")
	}
...
func (o VersionedAttributeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from versionedAttribute slice")
	}
...
func (o *VersionedAttributeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in VersionedAttributeSlice")
	}
...
func VersionedAttributeExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if versioned_attributes exists")
	}
