...
type ComponentFirmwareVersion struct {
	...
	InstallInband null.Bool         `boil:"install_inband" json:"install_inband,omitempty" toml:"install_inband" yaml:"install_inband,omitempty"`
...
var ComponentFirmwareVersionWhere = struct {
	...
	InstallInband whereHelpernull_Bool
}{
	...
	InstallInband: whereHelpernull_Bool{field: "\"component_firmware_version\".\"install_inband\""},
}
